...
\033[1;91m☞ Auther     : A4_ARHAM_M4_MASTER
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update A4_ARHAM Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' A4_ARHAM WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WellCome To A4_ARHAM')
	    psb('Congratulations A4_ARHAM Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ ARHAM✓')
	    psb('🔓Password ☆ JEE✓')
	    psb('Subscrib My Youtube Channel A4 ARHAM M4 MASTER✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/A4 ARHAM && python2 A4.py')
	elif bm =='3':
